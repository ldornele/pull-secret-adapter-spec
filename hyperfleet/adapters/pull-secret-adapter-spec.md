...
|------------|---------|----------|-----------|
| `secretmanager.secrets.create` | Create new secret | Yes | [path parameters create](https://docs.cloud.google.com/secret-manager/docs/reference/rest/v1/projects.secrets/create#path-parameters) |
