...
|------------|---------|----------|-----------|
| `POST https://secretmanager.googleapis.com/v1/{parent=projects/*}/secrets` | Create new secret | Yes | | `secretmanager.secrets.create` | Create new secret | Yes | [secrets.create - path parameters](https://docs.cloud.google.com/secret-manager/docs/reference/rest/ |
